...
public class Recherche_locale_test {
	public static void main(String args[]) {
		String filename="dense_10_30_3_1_I";
		...
		try {
			...
			Solution solution = Checker.generate_solution_from_file("../Evacuation/src/Examples/"+filename+"_2.txt");
			System.out.println("Cette solution est : "+Checker.check_solution(solution, graph));
